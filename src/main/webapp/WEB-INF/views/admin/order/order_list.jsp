    ...
    <section class="content container-fluid">
      ...
      <div class="row">
    		<div class="col-md-12">
                ...
                <td><button type="button" class="btn btn-primary btn_order_detail" data-ord_code="${orderVO.ord_code}">주문상세</button></td>
...
//맨처음하는작업 orderDetailTemplate = 핸들러틀 주소
